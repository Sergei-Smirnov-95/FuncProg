...
--На вход подаётся два натуральных числа ограничивающих поиск, 
--в ответ выдаётся наибольшее из искомых чисел или же 0 в случае отсутствия такого 
quad x y = let hf y = ( floor $ sqrt $ fromIntegral y )^2 in 
			if hf y > x && hf y < y then hf y 
